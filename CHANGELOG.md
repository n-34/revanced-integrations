...
* **YouTube:** Check if `protobufBuffer` can be filtered ([b078f0c](https://github.com/n-34/revanced-integrations/commit/b078f0ca37020b1aefdbe34724370f6b08c7d600))
* **YouTube:** Correctly show channel page on tablet devices ([#558](https://github.com/n-34/revanced-integrations/issues/558)) ([d0edafb](https://github.com/n-34/revanced-integrations/commit/d0edafb1afc7b87a8eeb085a9e48dc2d20af2f3a))
...
* **YouTube:** Fix video playback by switching to ReVanced GmsCore vendor ([#589](https://github.com/n-34/revanced-integrations/issues/589)) ([6e947e2](https://github.com/n-34/revanced-integrations/commit/6e947e24c2ac36e1bddcd25412870a36aa6c85c8))
...
* **YouTube:** Prevent playing touch interaction sound when unintended ([6e414ec](https://github.com/n-34/revanced-integrations/commit/6e414ec6c2a40d70f810b0ade1d8c41cadafff8d))
* **YouTube:** Rename `Restore old seekbar thumbnails` and `Restore old quality menu` ([#510](https://github.com/n-34/revanced-integrations/issues/510)) ([6b00f90](https://github.com/n-34/revanced-integrations/commit/6b00f90fb7561d59de59d76d43fff8c1d057dce6))
...
* Allow choosing the vendor of GmsCore via patch options ([#529](https://github.com/n-34/revanced-integrations/issues/529)) ([fba7181](https://github.com/n-34/revanced-integrations/commit/fba7181e70d695d7fb13c530754dc1db99b87216))
...
* **GmsCore support:** Open download link if possible ([#596](https://github.com/n-34/revanced-integrations/issues/596)) ([999727d](https://github.com/n-34/revanced-integrations/commit/999727d5e6889b6242473f1b14bf618918417e77))
...
* Modernize restart logic ([#527](https://github.com/n-34/revanced-integrations/issues/527)) ([0ea4e72](https://github.com/n-34/revanced-integrations/commit/0ea4e720edab250aac02b32a8014c24b1127d02f))
* Move strings to resources for localization ([#420](https://github.com/n-34/revanced-integrations/issues/420)) ([7ae10be](https://github.com/n-34/revanced-integrations/commit/7ae10be507244594adf6704975fdf4cfd797a96e))
...
* **Sync for Reddit:** Add `Fix /s/ links` patch ([a8c82ad](https://github.com/n-34/revanced-integrations/commit/a8c82ad27b74e929311536227dee0909ebc27ee1))
...
* **Tiktok - Playback speed:** Remember playback speed ([#543](https://github.com/n-34/revanced-integrations/issues/543)) ([21ced14](https://github.com/n-34/revanced-integrations/commit/21ced14791c6c26745ad88af5ce9d4970ad4c951))
...
* **Tiktok:** Add `Remember clear mode` patch ([#544](https://github.com/n-34/revanced-integrations/issues/544)) ([05eddb6](https://github.com/n-34/revanced-integrations/commit/05eddb68d5d5de1b76545c42313d4e9f9ba6712e))
* **Tiktok:** Bump compatibility to `32.5.3` ([#536](https://github.com/n-34/revanced-integrations/issues/536)) ([10a1e16](https://github.com/n-34/revanced-integrations/commit/10a1e168d062adc3c979de17738d8cf1b8f25d63))
...
* **X:** Add `Open links as query` patch ([#570](https://github.com/n-34/revanced-integrations/issues/570)) ([95ca632](https://github.com/n-34/revanced-integrations/commit/95ca632d40b90ea8160dbbf33fd5d7f2281cf711))
* **YouTube - Alternative Thumbnails:** Add option to use DeArrow ([#534](https://github.com/n-34/revanced-integrations/issues/534)) ([c4ee6ca](https://github.com/n-34/revanced-integrations/commit/c4ee6ca4dde13ab8ce6f9cf94f1910455f9d9ecc))
* **YouTube - Alternative thumbnails:** Selectively enable for home / subscription / search ([#593](https://github.com/n-34/revanced-integrations/issues/593)) ([4c81e96](https://github.com/n-34/revanced-integrations/commit/4c81e96a74cfc49923238c4a294b59f36b5e6c36))
* **YouTube - Change start page:** Add more start pages ([27421fb](https://github.com/n-34/revanced-integrations/commit/27421fb5783e677075ab0c220030d6af64cfaa18))
* **YouTube - Comments:** Add option to hide timestamp and emoji buttons ([#621](https://github.com/n-34/revanced-integrations/issues/621)) ([6e9e122](https://github.com/n-34/revanced-integrations/commit/6e9e12235a69a1f3759180abd48e65b151b62e9a))
* **YouTube - Custom filter:** Custom filtering of the protocol buffer ([#562](https://github.com/n-34/revanced-integrations/issues/562)) ([0eb7f3f](https://github.com/n-34/revanced-integrations/commit/0eb7f3f3af99bf6566526f9c48db2248d93e166c))
...
* **YouTube - Disable precise seeking gesture:** Use better patch name ([2453d30](https://github.com/n-34/revanced-integrations/commit/2453d30970ac59d78647386f4fe5d904dbc145e4))
* **YouTube - Downloads:** Use external downloader when selecting 'Download' in home feed flyout menu ([#587](https://github.com/n-34/revanced-integrations/issues/587)) ([254da31](https://github.com/n-34/revanced-integrations/commit/254da31d16c39781f46e1cdea1e9ba22e2fce6d1))
* **YouTube - External downloader:** Add ability to use in-app download button ([771a0de](https://github.com/n-34/revanced-integrations/commit/771a0de3bc9bec3ec5a8e4f8b02edfa9df7b1997))
* **YouTube - GmsCore:** Require ignoring battery optimizations ([#599](https://github.com/n-34/revanced-integrations/issues/599)) ([fd2a9d0](https://github.com/n-34/revanced-integrations/commit/fd2a9d0287599aaafa817987fd0815e4f0ae72b9))
* **YouTube - Hide ads:** Add option to hide the 'Visit store' button on channel pages ([#622](https://github.com/n-34/revanced-integrations/issues/622)) ([9de566c](https://github.com/n-34/revanced-integrations/commit/9de566ca02398ab9c628565091ed02316c5e1ed0))
* **YouTube - Hide ads:** Hide fullscreen ads ([0f6dee5](https://github.com/n-34/revanced-integrations/commit/0f6dee5bae6b8017a53830587e09079942bc24aa))
...
* **YouTube - Hide ads:** Hide shopping links in video description ([11e7c04](https://github.com/n-34/revanced-integrations/commit/11e7c04b707d86901809db3b4f427a0155787177))
* **YouTube - Hide layout components:** Add option to hide horizontal shelves ([#598](https://github.com/n-34/revanced-integrations/issues/598)) ([fedace0](https://github.com/n-34/revanced-integrations/commit/fedace02fd5c443ef37dcf77253438b041f4c3f9))
* **YouTube - Hide layout components:** Disable hiding search result shelf header by default ([b280de3](https://github.com/n-34/revanced-integrations/commit/b280de31957631180f07057cc7e466bd26e2f7fb))
* **YouTube - Hide layout components:** Filter home/search results by keywords ([#584](https://github.com/n-34/revanced-integrations/issues/584)) ([0cbad98](https://github.com/n-34/revanced-integrations/commit/0cbad9820577c476f1f29b6ac77611b38afbb950))
* **YouTube - Hide layout components:** Hide "For You" shelf in channel page ([2613e10](https://github.com/n-34/revanced-integrations/commit/2613e102cc446c910c4a2f750cc034e12995dd39))
* **YouTube - Hide layout components:** Hide "Join" button ([e225468](https://github.com/n-34/revanced-integrations/commit/e2254681cd77481376e4c3f8c556db510fdfce6c))
* **YouTube - Hide layout components:** Hide "Notify me" button ([b87d806](https://github.com/n-34/revanced-integrations/commit/b87d8066597a2c989480de47561007844964a0e4))
...
* **YouTube - Hide layout components:** Hide description components ([726a251](https://github.com/n-34/revanced-integrations/commit/726a2510a5b28da3afb77c7f5fdda87a3bd2c809))
* **YouTube - Hide layout components:** Hide playables ([d6cd550](https://github.com/n-34/revanced-integrations/commit/d6cd550880596de5cd2eb4a0d1325a73326d4af9))
* **YouTube - Hide layout components:** Hide search result recommendations ([d241e43](https://github.com/n-34/revanced-integrations/commit/d241e437ee25cc2211bf06b4a7f8fd1c295fad25))
* **YouTube - Hide layout components:** Hide search result shelf header ([93a3045](https://github.com/n-34/revanced-integrations/commit/93a30453d9693e015b1f58a12f85cf355770a4ca))
* **YouTube - Hide layout components:** Hide timed reactions ([b472aee](https://github.com/n-34/revanced-integrations/commit/b472aeeed7904f6b6d537dfbddda1a97c7ddcd5e))
* **YouTube - Hide layout components:** Hide video quality menu footer ([04608d3](https://github.com/n-34/revanced-integrations/commit/04608d32e88d184e4662a71498d7a49c1fbbdb25))
* **YouTube - Hide Shorts components:** Hide 'Buy super thanks' button ([#633](https://github.com/n-34/revanced-integrations/issues/633)) ([303754c](https://github.com/n-34/revanced-integrations/commit/303754c46f6d3471405d67b7911065fc3a87f721))
* **YouTube - Hide Shorts components:** Hide `Shop`, `Location` and `Save sound to playlist` buttons ([#614](https://github.com/n-34/revanced-integrations/issues/614)) ([acfa3c9](https://github.com/n-34/revanced-integrations/commit/acfa3c98868b6d84572ee682ad806a0282ac6dad))
* **YouTube - Hide Shorts components:** Hide like / dislike button in video ads ([#619](https://github.com/n-34/revanced-integrations/issues/619)) ([b2b6b8c](https://github.com/n-34/revanced-integrations/commit/b2b6b8c3d7d3c706552ffe70f3ed0314fe5284b6))
* **YouTube - Hide Shorts components:** Hide like and dislike buttons ([2a08e5a](https://github.com/n-34/revanced-integrations/commit/2a08e5a98e9e9a00bb306313ff487d67c042a92e))
* **YouTube - Hide Shorts components:** Hide sound metadata label ([46d8ef6](https://github.com/n-34/revanced-integrations/commit/46d8ef6f88bd4c912a45357541291af38b5fc81f))
* **YouTube - Hide shorts components:** Hide subscribe button when paused separately from subscribe button ([3ac869f](https://github.com/n-34/revanced-integrations/commit/3ac869fa6ae095f074481d98d9a4eea207eda00d))
* **YouTube - Hide Shorts components:** Hide tagged products, hide search suggestions ([#615](https://github.com/n-34/revanced-integrations/issues/615)) ([0586fb7](https://github.com/n-34/revanced-integrations/commit/0586fb70e347c25742e03102441cfb37315b5937))
* **YouTube - Hide Shorts components:** Hide title and full video link label ([59165de](https://github.com/n-34/revanced-integrations/commit/59165de801a5481fa4055dcf1797fe84dce235c0))
* **YouTube - Hide Shorts components:** Selectively hide Shorts for home / subscription / search ([#592](https://github.com/n-34/revanced-integrations/issues/592)) ([1ee99aa](https://github.com/n-34/revanced-integrations/commit/1ee99aa6f0b4af15eeca25c7e21e8a0f5e9d189a))
...
* **YouTube - Navigation buttons:** Add option to hide navigation button labels ([#635](https://github.com/n-34/revanced-integrations/issues/635)) ([6bd0ac2](https://github.com/n-34/revanced-integrations/commit/6bd0ac20dcfc76bfd044fb9f2f03ce98d6efc535))
* **YouTube - Return YouTube Dislike:** Support version `18.37.36` ([#490](https://github.com/n-34/revanced-integrations/issues/490)) ([245c3b3](https://github.com/n-34/revanced-integrations/commit/245c3b35373313d49cc5b1c2fd8e9deebb6258a5))
* **YouTube - Return YouTube Dislike:** Support version `18.43.45` and `18.44.41` ([#514](https://github.com/n-34/revanced-integrations/issues/514)) ([a5245b8](https://github.com/n-34/revanced-integrations/commit/a5245b85a829a86b535cf305cac49d14b709708d))
* **YouTube - Spoof app version:** Add `18.09.39` to restore library tab ([#552](https://github.com/n-34/revanced-integrations/issues/552)) ([3bd48dc](https://github.com/n-34/revanced-integrations/commit/3bd48dca09094f58f68b8cfb6ff047fafa40b7e3))
* **YouTube - Spoof app version:** Add target versions ([#574](https://github.com/n-34/revanced-integrations/issues/574)) ([da57fb9](https://github.com/n-34/revanced-integrations/commit/da57fb95233ed251518fbd5c56a92bc39c4e0015))
* **YouTube - Swipe controls:** Save and restore brightness and add auto-brightness toggle ([#610](https://github.com/n-34/revanced-integrations/issues/610)) ([1c8e2b2](https://github.com/n-34/revanced-integrations/commit/1c8e2b29410048a352cb6aad3dd02773459f91a0))
* **YouTube - Theme:** Disable gradient loading screen ([fd09e46](https://github.com/n-34/revanced-integrations/commit/fd09e46d01c820632cfe440dac34f5cd957e793d))
...
* **youtube/return-youtube-dislike:** decrease request timeout ([#171](https://github.com/n-34/revanced-integrations/issues/171)) ([c372e0e](https://github.com/n-34/revanced-integrations/commit/c372e0e9bdf21ec35b7edbae5e841236f27bd850))
* **youtube/return-youtube-dislike:** do not debug log when updating the text ([080e22b](https://github.com/n-34/revanced-integrations/commit/080e22b1bf18f9c09e7687aa694d6601318bd99b))
* **youtube/return-youtube-dislike:** show dislike as a percentage ([#234](https://github.com/n-34/revanced-integrations/issues/234)) ([7840bc4](https://github.com/n-34/revanced-integrations/commit/7840bc48ba5309eebadeb0f708570bac9f7166e0))
* **youtube/return-youtube-dislike:** style for minimum width ([#284](https://github.com/n-34/revanced-integrations/issues/284)) ([a80fab7](https://github.com/n-34/revanced-integrations/commit/a80fab7070be203aa8aaf4c8422ea8e998843e67))
* **youtube/return-youtube-dislike:** support for shorts ([#312](https://github.com/n-34/revanced-integrations/issues/312)) ([0aef5e6](https://github.com/n-34/revanced-integrations/commit/0aef5e60e280b63490dac8d1b706e896fdf913a2))
* **youtube/settings:** add reset button to edit preference dialog ([#383](https://github.com/n-34/revanced-integrations/issues/383)) ([cb5a4d0](https://github.com/n-34/revanced-integrations/commit/cb5a4d0c9b3b340928695fcb1d10b164a6dcef27))
* **youtube/settings:** disable preference control if the feature is turned off.  show a dialog explaining side effects of some patches ([#328](https://github.com/n-34/revanced-integrations/issues/328)) ([a0ad968](https://github.com/n-34/revanced-integrations/commit/a0ad968aaa66422e67de2a61d76bc7aa88f08bf6))
* **youtube/sponsorblock:** automatically hide skip button ([#365](https://github.com/n-34/revanced-integrations/issues/365)) ([75dad2f](https://github.com/n-34/revanced-integrations/commit/75dad2f3071c19aa097ebdc7bd83d1ce9afb78ea))
* **youtube/sponsorblock:** skip segments once automatically ([#190](https://github.com/n-34/revanced-integrations/issues/190)) ([06bebd7](https://github.com/n-34/revanced-integrations/commit/06bebd7017980880765a5735b1dc0502a01c5037))
* **youtube/sponsorblock:** skip to video highlight ([#352](https://github.com/n-34/revanced-integrations/issues/352)) ([03f09cf](https://github.com/n-34/revanced-integrations/commit/03f09cf7bce1747b1d402f3a3e16dd69c364dfce))
* **youtube/spoof-app-version:** user selectable version to spoof ([#375](https://github.com/n-34/revanced-integrations/issues/375)) ([f6f6c93](https://github.com/n-34/revanced-integrations/commit/f6f6c93c57bdbec13f09acd802f58554cb981f3a))
* **youtube/spoof-signature-verification:** automatic signature spoofing ([d16980e](https://github.com/n-34/revanced-integrations/commit/d16980ef2f18b7b5752be36f0183985c6c398ea1))
* **youtube/spoof-signature-verification:** enable by default ([#357](https://github.com/n-34/revanced-integrations/issues/357)) ([214f2c8](https://github.com/n-34/revanced-integrations/commit/214f2c89c2884f250af557e6bf03fefb64a056b6))
* **youtube/swipe-controls:** add option to save and restore brightness ([b5a71a8](https://github.com/n-34/revanced-integrations/commit/b5a71a843eaecaf9f2566d0b6a3c21422b14a44f))
* **youtube/theme:** add a switch to enable/disable custom seekbar color ([#442](https://github.com/n-34/revanced-integrations/issues/442)) ([2a784a4](https://github.com/n-34/revanced-integrations/commit/2a784a47d18da90ce23fcd527eef1f6e2d8e166d))
* **youtube/theme:** change seekbar color via preference ([1185cee](https://github.com/n-34/revanced-integrations/commit/1185ceedf7fdb40759261ae8560e79604c8cb743))
* **youtube/theme:** color explore drawer background ([#203](https://github.com/n-34/revanced-integrations/issues/203)) ([cb40408](https://github.com/n-34/revanced-integrations/commit/cb404086ad7b74a4280ccfaaed49e1edafe6eaf8))
* **youtube/video-speed:** change custom video speeds inside app settings ([#393](https://github.com/n-34/revanced-integrations/issues/393)) ([b42790f](https://github.com/n-34/revanced-integrations/commit/b42790fbca0f6c854d41871834fd6266dd2ea106))
* **youtube/wide-searchbar:** rename patch ([8493f57](https://github.com/n-34/revanced-integrations/commit/8493f57879f0075c73932240b61bf0c52efda0ed))
* **youtube:** `copy-video-url` patch ([#263](https://github.com/n-34/revanced-integrations/issues/263)) ([e856d9d](https://github.com/n-34/revanced-integrations/commit/e856d9dccdf11888005e757e84a06523ad2c8dc5))
* **youtube:** `disable-zoom-haptics` patch ([#217](https://github.com/n-34/revanced-integrations/issues/217)) ([fe74f6d](https://github.com/n-34/revanced-integrations/commit/fe74f6d8a6740a4d4544344474756c8ac717748f))
* **youtube:** `hide-breaking-news-shelf` patch ([#258](https://github.com/n-34/revanced-integrations/issues/258)) ([eec90ee](https://github.com/n-34/revanced-integrations/commit/eec90ee04cdfcad08f0448c0f2e860e6eb25294f))
* **youtube:** `hide-captions-button` patch ([#175](https://github.com/n-34/revanced-integrations/issues/175)) ([867645e](https://github.com/n-34/revanced-integrations/commit/867645ea5b853c01e9f3f0a87797b0bba62460fa))
* **youtube:** `hide-floating-microphone-button` patch ([cb77e96](https://github.com/n-34/revanced-integrations/commit/cb77e96da91bb4707d8559757cd86a7583f8048b))
* **youtube:** `hide-load-more-button` patch ([#389](https://github.com/n-34/revanced-integrations/issues/389)) ([7da9d44](https://github.com/n-34/revanced-integrations/commit/7da9d440eedfc895b49aac40498f0279156ad117))
* **youtube:** `hide-mix-playlists` patch ([#177](https://github.com/n-34/revanced-integrations/issues/177)) ([0e6a92f](https://github.com/n-34/revanced-integrations/commit/0e6a92fb33fbe660c71dcf15146cde7131693619))
* **youtube:** `hide-player-buttons` patch ([d5bcef2](https://github.com/n-34/revanced-integrations/commit/d5bcef2cdbe5dfdb1ad2552e7fde339cee1a3f27))
* **youtube:** `navigation-buttons` patch ([68f42fc](https://github.com/n-34/revanced-integrations/commit/68f42fc9800210f6c4d6f8e85c0132bf0cbc06d3))
* **youtube:** `open-links-directly` patch ([#201](https://github.com/n-34/revanced-integrations/issues/201)) ([c3c1656](https://github.com/n-34/revanced-integrations/commit/c3c16563ea4e55234b8dea24732ce5e53bb562c8))
* **youtube:** `open-links-externally` patch ([4cbe833](https://github.com/n-34/revanced-integrations/commit/4cbe8338b3f4ab49139168d7a3d0c9ebebf68952))
* **youtube:** `remember-playback-rate` patch ([b5c0c84](https://github.com/n-34/revanced-integrations/commit/b5c0c843a502a7f4938053d136e826fbf7399e7b))
* **youtube:** `spoof-app-version` patch ([#282](https://github.com/n-34/revanced-integrations/issues/282)) ([fd818a3](https://github.com/n-34/revanced-integrations/commit/fd818a35f5252fc0a37e12b528e020cdfac0ab53))
* **YouTube:** Add 'About' preference to settings menu ([#608](https://github.com/n-34/revanced-integrations/issues/608)) ([b8f260e](https://github.com/n-34/revanced-integrations/commit/b8f260ebd3e7c2dc50a57cd060b76f2e0fc4a89c))
* **YouTube:** Add `Alternative thumbnails` patch ([#462](https://github.com/n-34/revanced-integrations/issues/462)) ([d354356](https://github.com/n-34/revanced-integrations/commit/d354356b2d9052bc0d388633ed9eb0206f7c2058))
* **YouTube:** Add `Announcements` patch ([#503](https://github.com/n-34/revanced-integrations/issues/503)) ([59687f1](https://github.com/n-34/revanced-integrations/commit/59687f1a39768ab71b2680a5c49df5aaae0d3b4c))
* **YouTube:** Add `Bypass URL redirects` patch ([9109653](https://github.com/n-34/revanced-integrations/commit/91096532eedf396920d69932638f667cbf850cbe))
* **YouTube:** Add `Change start page` patch ([792dc0c](https://github.com/n-34/revanced-integrations/commit/792dc0c52210dc9b1560290b0cc2afad572c584c))
* **YouTube:** Add `Custom player overlay opacity` patch ([#449](https://github.com/n-34/revanced-integrations/issues/449)) ([44dccb3](https://github.com/n-34/revanced-integrations/commit/44dccb3d658852e92aaf8d17e36dc205f1b3eb05))
* **YouTube:** Add `Disable fine scrubbing gesture` patch ([4498f39](https://github.com/n-34/revanced-integrations/commit/4498f39b8c4900fccdc359d0c687c26db23526c3))
* **YouTube:** Add `Disable fullscreen ambient mode` patch ([bf50711](https://github.com/n-34/revanced-integrations/commit/bf5071107b8bc88ac6562d45bfa28bdab8e566c7))
* **YouTube:** Add `Disable rolling number animations` patch ([#519](https://github.com/n-34/revanced-integrations/issues/519)) ([ce0bedc](https://github.com/n-34/revanced-integrations/commit/ce0bedc5d3b332760ee4d816a57fe64dc754ea0f))
* **YouTube:** Add `Disable suggested video end screen` patch ([6bd5aae](https://github.com/n-34/revanced-integrations/commit/6bd5aae9772e80809dbee9f8fffc1247364a9a13))
* **YouTube:** Add `Enable old seekbar thumbnails` patch ([75297a5](https://github.com/n-34/revanced-integrations/commit/75297a52c1c5f7c2b928964d08b055380f4a08fe))
* **YouTube:** Add `Enable slide to seek` patch ([b1ce7a7](https://github.com/n-34/revanced-integrations/commit/b1ce7a75eba53312d9522c87321ac83cb16d83cf))
* **YouTube:** Add `Enable tablet layout` patch ([d4570de](https://github.com/n-34/revanced-integrations/commit/d4570de0a791bd97c70ac46b84cbff75c6d0b274))
* **youtube:** add `hide-filter-bar` patch ([9649c3d](https://github.com/n-34/revanced-integrations/commit/9649c3dbc8406c3639c4fff9dd179d6d29886e60))
* **youtube:** add `hide-shorts-components` patch ([5ec90db](https://github.com/n-34/revanced-integrations/commit/5ec90db28a46e8f5d79f4793c141a7411a2da05d))
* **YouTube:** add `Player Flyout Menu` patch ([#416](https://github.com/n-34/revanced-integrations/issues/416)) ([b2085ae](https://github.com/n-34/revanced-integrations/commit/b2085aeebf4cfc21d69c0abfe545b382e2c82abe))
* **YouTube:** Add `Remove tracking query parameter` patch ([e84b7b3](https://github.com/n-34/revanced-integrations/commit/e84b7b328ea48e86d240d38cf83aa960f87d6902))
* **YouTube:** Add `Remove viewer discretion dialog` patch ([6f3f882](https://github.com/n-34/revanced-integrations/commit/6f3f88264e736b80f88103e795534f86f053c8d1))
* **YouTube:** Add `Spoof device dimensions` patch ([16f1163](https://github.com/n-34/revanced-integrations/commit/16f1163a346fef0a87ca9384c9bf6aea977dc8fb))
* **youtube:** add options to disable toasts on connection errors ([#402](https://github.com/n-34/revanced-integrations/issues/402)) ([ae18edd](https://github.com/n-34/revanced-integrations/commit/ae18edd047d7979307bc28f28db17bae2c5cc226))
* **YouTube:** Bump compatibility to `18.37.36` ([#483](https://github.com/n-34/revanced-integrations/issues/483)) ([5dadb0d](https://github.com/n-34/revanced-integrations/commit/5dadb0d523f2b1eb4216d43770af37a156c8a477))
* **youtube:** bump patches compatibility to v17.43.36 ([#194](https://github.com/n-34/revanced-integrations/issues/194)) ([6da66be](https://github.com/n-34/revanced-integrations/commit/6da66be067fdfe0db376925ecf5c96aa01162a2c))
* **youtube:** import / export of revanced settings ([#388](https://github.com/n-34/revanced-integrations/issues/388)) ([c3f08d8](https://github.com/n-34/revanced-integrations/commit/c3f08d8d7e8116496611b85508fbd54bb3a71992))
* **youtube:** remove `custom-video-buffer` patch ([#1718](https://github.com/n-34/revanced-integrations/issues/1718)) ([d5919a8](https://github.com/n-34/revanced-integrations/commit/d5919a8a2cff09bb884ea01ca6b01d8d2d0b8980))
* **youtube:** remove non working patch `hide-my-mix` ([436a84e](https://github.com/n-34/revanced-integrations/commit/436a84ee0785e5b0bed1b9a4a02b5be86eff4a4a))
* **youtube:** remove patch `open-links-directly` ([dce882b](https://github.com/n-34/revanced-integrations/commit/dce882b12809c074ae796b3551ddd82806bd084d))
* **youtube:** rename `video-speed` to `playback-speed` ([#438](https://github.com/n-34/revanced-integrations/issues/438)) ([630776f](https://github.com/n-34/revanced-integrations/commit/630776fd3514435dd83ef1c765a4f5b007e8e2f2))
* **YouTube:** Reorganize settings menu ([#571](https://github.com/n-34/revanced-integrations/issues/571)) ([eea4a48](https://github.com/n-34/revanced-integrations/commit/eea4a48cd565712c09d0ddd35ae256871ebe1964))
* **youtube:** show toasts along exceptions ([#293](https://github.com/n-34/revanced-integrations/issues/293)) ([dbf1f3f](https://github.com/n-34/revanced-integrations/commit/dbf1f3f0ce0500752e5d6c4ce49d7d2b27cc6dc4))
* **youtube:** support version `18.19.35` ([b47a781](https://github.com/n-34/revanced-integrations/commit/b47a781ba710e6fb66e144ef95cdd51af358e4de))
* **youtube:** support version `18.23.35` ([#433](https://github.com/n-34/revanced-integrations/issues/433)) ([dec7348](https://github.com/n-34/revanced-integrations/commit/dec73482038b3cc8b2031fd876643f89d937d142))
* **YouTube:** Support version 18.32.39 ([#464](https://github.com/n-34/revanced-integrations/issues/464)) ([aa9d892](https://github.com/n-34/revanced-integrations/commit/aa9d892cde59c39718529bc40a66b93a1cb78f82))
* **YouTube:** Support versions `18.48.39`, `18.49.37`, `19.01.34` ([#547](https://github.com/n-34/revanced-integrations/issues/547)) ([eaaa6fb](https://github.com/n-34/revanced-integrations/commit/eaaa6fbd20630f15bfec7c57713ec353f4072ac2))
* **youtube:** user selectable default video speed and quality ([#354](https://github.com/n-34/revanced-integrations/issues/354)) ([14223f4](https://github.com/n-34/revanced-integrations/commit/14223f40b5ca48f35bbecfd849dff20dfd309d92))


### Performance Improvements

* **general-ads:** hook pathBuilder ([c7756e1](https://github.com/n-34/revanced-integrations/commit/c7756e1299bdc2e241525ad89561ea67bc372e3a))
* **general-ads:** initialize blocks once ([5add970](https://github.com/n-34/revanced-integrations/commit/5add970f610c567f4b49f2a2ec8574ab393b5b5c))
* Only request required fields ([d20b768](https://github.com/n-34/revanced-integrations/commit/d20b768bc23d167d9f0d2c651c75b3f92944e731))
* remove obsolete SDK checks ([#174](https://github.com/n-34/revanced-integrations/issues/174)) ([1755662](https://github.com/n-34/revanced-integrations/commit/1755662a7aa87bebf5ab0d2bd3e51df0aafd4a92))
* Remove unnecessary api key parameter ([ba5e7d8](https://github.com/n-34/revanced-integrations/commit/ba5e7d870ee88ad45c233d914e1e2795de920cb2))
* return earlier when possible ([#427](https://github.com/n-34/revanced-integrations/issues/427)) ([12f3f97](https://github.com/n-34/revanced-integrations/commit/12f3f975525863e593216ecf36ca817d162474e1))
* **YouTube - Client spoof:** Reduce timeout to fetch storyboard renderer ([847cce4](https://github.com/n-34/revanced-integrations/commit/847cce43f6436c592c680820960f5270f799cb8d))
* **youtube/general-ads-patch:** reduce amount of components to filter ([#204](https://github.com/n-34/revanced-integrations/issues/204)) ([502feaf](https://github.com/n-34/revanced-integrations/commit/502feaf4448bf0442f852fbb8fdcb639239664db))
* **youtube/general-ads-patch:** reduce amount of ignored components ([#237](https://github.com/n-34/revanced-integrations/issues/237)) ([bf368e8](https://github.com/n-34/revanced-integrations/commit/bf368e8dd49a91ba1d7a1df66344f77d8b788072))
* **youtube/general-ads-patch:** reduce list of ignored component names ([#261](https://github.com/n-34/revanced-integrations/issues/261)) ([8d233a2](https://github.com/n-34/revanced-integrations/commit/8d233a2f82f49b93adb90e2b11c9fa46836dd9b0))
* **YouTube:** Filter litho components using prefix tree ([#447](https://github.com/n-34/revanced-integrations/issues/447)) ([18f2900](https://github.com/n-34/revanced-integrations/commit/18f29004b8d570915a0228e292f1256785ac2cab))
* **YouTube:** Reduce memory requirement for prefix tree searching ([#501](https://github.com/n-34/revanced-integrations/issues/501)) ([f5add51](https://github.com/n-34/revanced-integrations/commit/f5add51fa7eb620a6edd1b27f02d38618f144480))
